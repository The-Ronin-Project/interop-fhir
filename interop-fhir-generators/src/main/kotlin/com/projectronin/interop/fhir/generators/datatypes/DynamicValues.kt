...
object DynamicValues {
    ...
    fun codeableConcept(codeableConcept: CodeableConcept) = DynamicValue(DynamicValueType.CODEABLE_CONCEPT, codeableConcept)

    fun codeableConcept(codeableConceptGenerator: DataGenerator<CodeableConcept>) = codeableConcept(codeableConceptGenerator.generate())
