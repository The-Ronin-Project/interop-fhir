...
class R4ElementContainingValidatorTest {
    ...
    fun `validates non-null elements`() {
        ...
        every { validateElement(name, nameLocationContext) } returns failedValidation
    ...
    fun `validates each element in collection`() {
        ...
        every { validateElement(name1, LocationContext("Sample", "field.name[0]")) } returns failedValidation
        every { validateElement(name2, LocationContext("Sample", "field.name[1]")) } returns failedValidation
