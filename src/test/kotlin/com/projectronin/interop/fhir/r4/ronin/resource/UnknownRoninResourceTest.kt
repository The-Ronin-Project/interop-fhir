...
class UnknownRoninResourceTest {
    @Test
    fun `can serialize and deserialize JSON`() {
        ...
        val deserializedUnknownRoninResource = objectMapper.readValue<UnknownRoninResource>(json)
        assertEquals(unknownResource, deserializedUnknownRoninResource)
    }
    ...
    fun `can deserialize from JSON with nullable and empty fields`() {
        ...
        """.trimIndent()
        val unknownResource = objectMapper.readValue<UnknownRoninResource>(json)
