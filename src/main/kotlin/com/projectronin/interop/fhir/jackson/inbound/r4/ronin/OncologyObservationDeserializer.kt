...
/**
 * Jackson deserializer for [OncologyObservation]s
 */
class OncologyObservationDeserializer : StdDeserializer<OncologyObservation>(OncologyObservation::class.java) {
    override fun deserialize(p: JsonParser, ctxt: DeserializationContext): OncologyObservation {
