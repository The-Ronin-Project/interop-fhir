...
/**
 * Jackson deserializer for [OncologyCondition]s
 */
class OncologyConditionDeserializer : StdDeserializer<OncologyCondition>(OncologyCondition::class.java) {
    override fun deserialize(p: JsonParser, ctxt: DeserializationContext): OncologyCondition {
