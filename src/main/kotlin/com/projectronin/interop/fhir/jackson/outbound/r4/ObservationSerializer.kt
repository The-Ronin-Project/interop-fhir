...
/**
 * Jackson serializer for [Observation]s
 */
class ObservationSerializer : BaseDomainResourceSerializer<Observation>(Observation::class.java) {
    override fun serializeSpecificDomainElement(value: Observation, gen: JsonGenerator, provider: SerializerProvider) {
