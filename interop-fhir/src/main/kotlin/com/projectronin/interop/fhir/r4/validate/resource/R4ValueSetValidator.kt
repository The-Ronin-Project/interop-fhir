...
object R4ValueSetIncludeValidator : R4ElementContainingValidator<ValueSetInclude>() {
    private val requiredValueSetOrSystemError =
        FHIRError(
    ...
    private val missingRequiredFilterError =
        FHIRError(
    ...
    private val conflictingPropertiesError =
        FHIRError(
...
object R4ValueSetContainsValidator : R4ElementContainingValidator<ValueSetContains>() {
    private val requiredCodeOrDisplayError =
        FHIRError(
    ...
    private val missingRequiredCodeError =
        FHIRError(
    ...
    private val missingRequiredSystemError =
        FHIRError(
